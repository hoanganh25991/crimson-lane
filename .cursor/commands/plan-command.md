...
5. **Implement** — using the plan from the Planner, launch the matching domain Implementer agents (parallel within the same parallel-group, sequential across groups). Pick implementer by domain:
