...
3. **Check the theme** — Read `docs/game-theme.md` for color palette, style rules, and visual identity. New visuals should match.
4. **Check hero specs** — If working on hero visuals, read `docs/dota1-heroes-detail.md` for geometry and animation specs.
...
- Match the existing art style (low-poly, distinct colors per team — see `docs/game-theme.md`).
